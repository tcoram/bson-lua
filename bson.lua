...
local function fromLSB64(s)
  return fromLSB32(s) + (s:byte(5) * 4294967296) + (s:byte(6) * 1099511627776) + (s:byte(7) * 2.8147497671066e+14) +
             (s:byte(8) * 7.2057594037928e+16)
end
...
function bson.to_str(n, v)
  return "\002" .. n .. "\000" .. toLSB32(#v + 1) .. v .. "\000"
end
...
function bson.from_object_id(s)
  local str = ""
  for i = 1, 12 do
      str = str .. string.format("%02x", s:byte(i))
  end
  return str, s:sub(13)
end
